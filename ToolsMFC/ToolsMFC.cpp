...
// ToolsMFC.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CToolsMFCApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CToolsMFCApp

CToolsMFCApp::CToolsMFCApp()
{
...
// Единственный объект CToolsMFCApp

CToolsMFCApp theApp;


// Инициализация CToolsMFCApp

BOOL CToolsMFCApp::InitInstance()
{
